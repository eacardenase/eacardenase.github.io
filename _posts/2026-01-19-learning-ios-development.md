...
- [x] Book - iOS Programming (Swift 5.2)
- [x] Course - The Swift Arcade Professional iOS Development
- [x] Course - iOS 13 & Swift 5: Login, Sign Up & Onboarding (iOS 13)
- [x] Course - Level Up in Auto Layout
- [x] Course - iOS 13 & Swift 5: Chat App With FireStore
- [x] Course - Tinder FireStore Clone
- [x] Book - Concurrency by Tutorials (Swift 5.1, iOS 13)
